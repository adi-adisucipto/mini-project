    ...
    <label className="mb-6 flex items-center gap-3 text-gray-700">
      ...
      <div className="relative">
        <select
          ...
          className="rounded-md border border-gray-300 bg-white px-3 py-2 pr-8 text-base font-semibold text-[#87786C] shadow-sm focus:border-[#F6A273] focus:outline-none focus:ring-2 focus:ring-[#F6A273]/50"
        >
